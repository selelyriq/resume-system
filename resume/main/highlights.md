...
- **Automated 400+ repository migration** from GitHub Enterprise to GitHub SaaS, coordinating with application owners and repo stakeholders for safe, planned transitions.
...
- **Infrastructure as Code**: Terraform (state management, modules, multi-account design), Packer
- **Cloud Platforms**: AWS (EC2, S3, IAM, ECS, EKS, CloudWatch, Bedrock), Azure (VNet, AKS, Private Link)
- **DevOps & Automation**: GitHub Actions, ArgoCD, CI/CD pipelines, Ansible, Docker
